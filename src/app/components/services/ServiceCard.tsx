...
const ServiceCard = ({key, title, content, image} : ServiceCard) => {
  ...
  return (
    <div className='flex flex-col items-start justify-around gap-2 rounded-tl-[50px] rounded-br-[50px] drop-shadow-lg rounded-md bg-slate-50 h-[580px] '>
        <div className='h-[40%]  md:rounded-tl-[50px] '>
        ...
        <div className='px-8 border-1 flex flex-col items-start w-[80%] justify-center gap-[1rem] text-black text-md divide-y divide-red-600'>
